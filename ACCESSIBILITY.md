...
- **Web (desktop):** latest version of Chrome, Edge, Firefox, and Safari.
- **Web (mobile):** latest version of Mobile Safari and Chrome on Android.
- **Assistive technology:** VoiceOver (macOS / iOS), NVDA (Windows), JAWS (Windows), TalkBack (Android).

## Reporting accessibility issues

If you run into an accessibility barrier, please let us know.

1. **Open an issue** using the **accessibility issue template** (or apply the `accessibility` / `a11y` label).
...
* Based on [ACCESSIBILITY.md](https://github.com/open-source-accessibility/accessibility-toolkit/blob/main/ACCESSIBILITY.md)
* [Web Content Accessibility Guidelines (WCAG) 2.2](https://www.w3.org/TR/WCAG22/)
* [WAI-ARIA Authoring Practices Guide](https://www.w3.org/WAI/ARIA/apg/)
* [Web Accessibility Initiative (WAI)](https://www.w3.org/WAI/)
* [Accessibility Best Practices for Open Source Projects](https://opensource.guide/accessibility-best-practices-for-your-project/)
