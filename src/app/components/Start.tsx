      ...
      <div className="flex pt-10">
        ...
        <div className="flex-auto px-6">
          <div className="flex flex-wrap">
            ...
            <div className="w-full flex-none text-base font-medium text-slate-700 mt-2">
            ...
            <div className="space-x-5 flex text-base">
              <div>
                <p className="py-2">
                  ...
                  d'étude de la formation Plecotus 2024, dispensée par Natagora.
                </p>

                <p className="py-2">
                  Son objectif est de permettre à quiconque de travailler
                  l'identification des espèces de chauves-souris en hivers. Le
              ...
              <div>
                <p className="py-2">
                  N'hésitez pas à garder sous la main le mémo si vous débuttez.
                </p>
                <p className="py-2">
